...
I replaced the commericial [usearch --ublast tool](https://www.drive5.com/usearch/) by the open-source [blast tool](https://blast.ncbi.nlm.nih.gov/Blast.cgi). This allows me to add reparation_blast to bioconda for easy use in conda environments. (I also updated the python2.7 script to python3.6+) 
